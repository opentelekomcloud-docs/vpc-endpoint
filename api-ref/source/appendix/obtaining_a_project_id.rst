:original_name: vpcep_08_0003.html
...
-  :ref:`Obtain the Project ID by Calling an API <vpcep_08_0003__en-us_topic_0121673684_section86806471133>`
-  :ref:`Obtain the Project ID from the Console <vpcep_08_0003__en-us_topic_0121673684_section32975495318>`

.. _vpcep_08_0003__en-us_topic_0121673684_section86806471133:
...
You can call the API (GET https://{Endpoint}/v3/projects) to obtain a project ID. {Endpoint} is the IAM endpoint and can be obtained from `Regions and Endpoints <https://docs.otc.t-systems.com/en-us/endpoint/index.html>`__.
...
.. _vpcep_08_0003__en-us_topic_0121673684_section32975495318:
...
#. Click the username and select **My Credentials** from the drop-down list.
   ...
   .. figure:: /_static/images/en-us_image_0000002392005504.png
